...
export const generateMetadata = async ({ params }: { params: { country: string } }) => {
  ...
  return {
    title: `${country.charAt(0).toUpperCase() + country.slice(1)} Travel Guide | Infinite Journeys`,
    description: `Explore the best destinations, accommodations, and experiences in ${country}. Plan your perfect trip with Infinite Journeys.`,
    openGraph: {
      images: [`/images/${country}.jpg`],
    }
  };
};
