    ...
    >
          ...
          <div className="flex justify-between items-start">
            <div className="flex flex-col">
              <div className="flex items-center gap-1">
                <span className="font-semibold text-foreground hover:underline cursor-pointer">{authorName}</span>
            ...
            <button
              type="button"
              className="h-8 w-8 text-foreground hover:text-foreground hover:bg-black/5 dark:hover:bg-white/5 rounded-lg p-1 flex items-center justify-center"
            >
              <svg
      ...
      <div className="mt-2">
        {content.map((item, index) => (
          <p key={index} className="text-foreground text-base">
            {item}
          </p>
        ))}
        <span className="text-muted-foreground text-sm mt-2 block">{timestamp}</span>
      </div>
      ...
      {reply && (
        <div className="mt-4 pt-4 border-t border-black/[0.08] dark:border-white/[0.08]">
          <div className="flex gap-3">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-1">
                <span className="font-semibold text-foreground hover:underline cursor-pointer">{reply.authorName}</span>
